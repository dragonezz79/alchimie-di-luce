        ...
        <div className="container grid-2">
          <div>
            ...
            <div className="steps">
              ...
              <div className="step">
                <span className="check">✓</span>
                Lavoro energetico a distanza in connessione con il mondo
                angelico.
              </div>
        ...
        <div className="container center">
          ...
          <div className="grid-2" style={{ marginTop: '50px' }}>
            <div className="price-box wide">
              ...
              <p>
                È pensata per chi desidera porre{' '}
                <strong>3 domande secche</strong> agli Angeli. Per ogni domanda
                verrà estratta una carta e riceverai una risposta dedicata.
              </p>
          ...
          <p className="small">
            ...
            sostituiscono consulenze mediche, psicologiche, legali o
            finanziarie.
          </p>
        </div>
      </section>
      ...
      <section>
        <div className="container center">
          ...
          <p className="lead">
            ...
            preparazione, pagamento anticipato e modalità di restituzione
            finale.
          </p>
        ...
        <div className="container" style={{ maxWidth: '850px' }}>
          ...
          <details>
            ...
            <p>
              ...
              tranquillo, seduto o sdraiato, mentre io lavoro dal mio spazio
              sacro.
            </p>
          </details>
